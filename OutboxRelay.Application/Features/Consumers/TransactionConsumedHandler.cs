...
{
    public class TransactionConsumedHandler : IMessageHandler<Transaction>
    {
        ...
        public async Task HandleAsync(Transaction message, CancellationToken cancellationToken)
        {
